...
export function renderAnalyics() {
    // Dynamically load the CSS for the Analytics page
    if (!document.querySelector(`link[href="/frontend/pages/analyticspage/analyticsPage.css"]`)) {
        const link = document.createElement("link");
        link.rel = "stylesheet";
        link.href = "/frontend/pages/analyticspage/analyticsPage.css";
        document.head.appendChild(link);
    ...
    // Add HTML content for the Analytics page
    const app = document.getElementById("app");
    app.innerHTML = ` 
       <nav class="navbar">
        <div class="navbar-left">
    ...
    <div class="container">
        ...
        <div class="progress-section">
            <h2>Task 1 Progress</h2>
            <div class="Task1Progress">
                <div class="Task1p"></div>
            </div>
        </div>
        <div class="progress-section">
            <h2>Task 2 Progress</h2>
            <div class="Task2Progress">
                <div class="Task2p"></div>
            </div>
        </div>
        <div class="progress-section">
            <h2>Task 3 Progress</h2>
            <div class="Task3Progress">
                <div class="Task3p"></div>
            </div>
        </div>
        <div class="progress-section">
            <h2>Task 4 Progress</h2>
            <div class="Task4Progress">
                <div class="Task4p"></div>
            </div>
        </div>
